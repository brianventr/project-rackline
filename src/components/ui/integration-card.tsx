...
const ClaudeLogo = ({ className }: { className?: string }) => {
  const clipId = `claude-${useId().replace(/:/g, "")}`;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 28 28"
...
const MotionLogo = ({ className }: { className?: string }) => {
  const clipId = `motion-${useId().replace(/:/g, "")}`;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 28 28"
...
const TailwindLogo = ({ className }: { className?: string }) => {
  const clipId = `tailwind-${useId().replace(/:/g, "")}`;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 28 28"
    ...
    <div className="relative h-full w-full">
      ...
      <div className="absolute top-1/2 left-1/2 z-20 flex -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-lg border border-border bg-background p-0.5 shadow-md sm:rounded-2xl sm:p-2 sm:shadow-xl">
        <div className="rounded-lg border p-1 sm:rounded-xl sm:p-2.5">
          <Logo className="size-5 text-foreground sm:size-9" />
        </div>
        <motion.div
...
export function IntegrationCard({
  ...
  return (
    <Card className="mx-auto flex w-full flex-col overflow-hidden rounded-2xl border p-0 ring-0 sm:max-w-141 gap-0">
      ...
      <CardContent className="flex flex-col gap-6 p-6 sm:gap-8 sm:p-8">
        ...
        <Button
          asChild
          className="h-10 w-fit cursor-pointer rounded-full px-5 hover:bg-primary/80"
        >
          {isInternal ? (
