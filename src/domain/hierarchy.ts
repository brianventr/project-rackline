...
export const HIERARCHY_LEVELS: readonly HierarchyLevel[] = [
  ...
  },
  {
    ...
    group: "where",
    title: "Bay",
    short: "One shelf-width of a rack, numbered from the start of the aisle.",
  ...
  },
  {
    ...
    long: "Rackline calls bins locations. Each has a type (receiving, storage, production, shipping) and a slot role: a pick face pickers take from, or a bulk bay that refills it.",
    example: "A-01-02-2",
    term: "pick-face",
    path: "/stock/locations",
  },
