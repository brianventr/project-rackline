...
Iteration 26 adds equipment custody: register forklifts and pallet jacks, exclusive operator checkout for a shift and/or WMS document, OSHA-style pre-use inspection, and stamp the truck onto inventory movements. Fail inspection marks the machine out of service. Qty stays integer pieces on location:item.
